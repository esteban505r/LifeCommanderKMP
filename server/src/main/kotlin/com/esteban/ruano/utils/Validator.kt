...
object Validator {
    ...
    fun isValidDateTimeWithSecondsFormat(dateTime: String): Boolean {
        val dateTimeWithSecondsFormatRegex = "^(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[0-2])/\\d{4} ([01]?[0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$".toRegex()
        return dateTimeWithSecondsFormatRegex.matches(dateTime)
    }
}