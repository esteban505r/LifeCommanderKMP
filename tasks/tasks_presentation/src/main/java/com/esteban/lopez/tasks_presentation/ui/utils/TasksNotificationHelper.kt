package com.esteban.ruano.tasks_presentation.ui.utils
...
class TasksNotificationHelperImpl: NotificationsHelper {
    override fun createChannel(context: Context): NotificationChannel {
        val name = context.getString(R.string.tasks_channel_name)
        val descriptionText = context.getString(R.string.channel_description)
        val importance = NotificationManager.IMPORTANCE_DEFAULT
        val mChannel = NotificationChannel(context.getString(R.string.task_channel_id), name, importance)
 ...
 override fun showNotification(context: Context, id:Int,notification: Notification,) {
    ...
    override fun createNotification(
        ...
        return NotificationCompat.Builder(context, context.getString(R.string.task_channel_id))
