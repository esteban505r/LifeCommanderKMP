...
class Login(
    ...
    suspend operator fun invoke(email: String, password: String, fcmToken: String?, timezone: String?): Result<LoginModel> {
        return repository.login(email, password, fcmToken, timezone)
    }
}